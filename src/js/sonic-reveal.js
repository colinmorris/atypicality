...
let attr_texts = {
  ...
  acousticness: [
    ...
    `Cher's extravagantly autotuned vocals&#8202;—&#8202;a famous and trendsetting feature of the song&#8202;—&#8202;aren't fooling anyone. Not even a computer. This song is 0 percent acoustic.`
  ],
  liveness: [
  ...
  valence: [
    ...
    `“Believe” gets a slightly below average 48% valence score. We might agree with that based on the lyrics (“I really don't think it’s strong”), but the algorithm only has access to the raw audio of the song, not the liner notes. Its assessment of valence comes from the song‘s sound.`,
