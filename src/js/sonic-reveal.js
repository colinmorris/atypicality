...
let attr_texts = {
  danceability: [
    ...
    `The <b>danceability</b> score is a measure of how suitable a song is to dance to. <i>Believe</i> is a real banger, so it's a little surprising it wasn't rated 100% on this scale. However, it's important to note that these scores don't come from kids on American Bandstand - they come from a computer. Danceability is calculated algorithmically using criteria like the tempo and the strength and regularity of the beat.`,
  ...
  tempo: [
    `<b>Tempo</b> is the simplest, most primitive sonic feature in our toolbox. It's just the speed of the song. <i>Believe</i> clocks in at a moderately fast 133 beats per minute.`,
    // TODO: should confirm legitimacy of these explanations of failure modes
    `Computers are generally pretty good at guessing a song's tempo (<i>Believe</i>'s official sheet music gives the tempo as a "moderate disco beat" of 132 bpm - not bad!). But when they do fail, they tend to fail pretty spectacularly. The most common failure mode is to guess half the actual tempo (e.g. because of a weak 2nd and 4th beat), or double it (e.g. because of a strong hi-hat on the eigth notes).`
  ],
  energy: [
    ...
    `<i>Believe</i>, with its <a href="https://www.youtube.com/watch?v=Lxc2nCmZzrs">"boots and pants"</a> techno beat and throbbing synths gets a very high energy score.`
  ],
  acousticness: [
  ...
  speechiness: [
    `<b>Speechiness</b> is a measure of the amount of spoken-word (as opposed to singing) in the track. <i>Believe</i> gets a low score here, though not quite 0 (perhaps because of the "I don't need you anymore" section of the bridge, which has a somewhat speechy feel).`
  ],
  instrumentalness: [
    `<b>Instrumentalness</b> is the estimated likelihood that this is an instrumental track. <i>Believe</i>, with its prominent vocals throughout, gets a 0 on this.`
  ],
  valence: [
